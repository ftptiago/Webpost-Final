...
<html>
    ...
    <body>
        ...
        <form class="form col-md-12 center-block" action="insertsobre.php" method="POST">
               
                    <input type="text" name="titulo" class="form-control input-lg" placeholder="Nome">
                <br/>
               
                   <textarea type="text" name="texto1" class="form-control input-lg" placeholder="Texto 1"></textarea>
               <br/>
               
               <textarea type="text" name="texto2" class="form-control input-lg" placeholder="Texto 2"></textarea>
               <br/>
