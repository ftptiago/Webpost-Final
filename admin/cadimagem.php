...
<html>
    <head>
		...
		<meta charset="utf-8">
		<title>Admin - Criar novo imagem</title>
    ...
    <body>
        ...
        <form class="form col-md-12 center-block" enctype="multipart/form-data" action="insertimagem.php" method="POST">
               
                    <input type="text" name="titulo" class="form-control input-lg" placeholder="Titulo">
                <br/>
               
                    <input type="text" name="link" class="form-control input-lg" placeholder="link menu ">
