    ...
    <body>
       ...
       <div class="row well col-lg-4">
            <form class="form col-md-12 center-block" enctype="multipart/form-data" action="upimagem.php" method="POST">
                    ...
                    <input type="text" name="titulo" class="form-control input-lg" value="<?php echo $row['titulo']; ?>">
                <br/>               
                <input type="text" name="link" class="form-control input-lg" value="<?php echo $row['link']; ?>">
                             
               <input id="arquivo" name="arquivo" type="file" class="form-control input-lg" placeholder="Imagem">
               <br/>
               
                
                <input type="hidden" name="valor" id="valor" value="<?php echo $row['img']; ?>">
