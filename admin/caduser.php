...
<html>
    ...
    <body>
        ...
        <form class="form col-md-12 center-block" action="insert.php" method="POST">
                    ...
                    <input type="text" name="user" class="form-control input-lg" placeholder="Nome">
                <br/>
               ...
               <br/>
                ...
                echo'<br/><input type="text" name="regra" class="form-control input-lg" value="" placeholder="Validar">';
