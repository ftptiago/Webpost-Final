...
<html>
    ...
    <body>
        ...
        <form class="form col-md-12 center-block" action="upsobre.php" method="POST">
               
                    <input type="text" name="titulo" class="form-control input-lg" placeholder="Nome" value="<?php echo $row['titulo']; ?>">
                <br/>
               
                   <textarea type="text" name="texto1" class="form-control input-lg" placeholder="Texto 1"><?php echo $row['texto1']; ?></textarea>
               <br/>
               
               <textarea type="text" name="texto2" class="form-control input-lg" placeholder="Texto 2"><?php echo $row['texto2']; ?></textarea>
               <br/>
